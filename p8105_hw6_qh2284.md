...
```
    ...
    ## # A tibble: 6 × 3
    ##   r.squared log_beta12 log_beta01
    ##       <dbl>      <dbl>      <dbl>
    ## 1     0.910      -5.89       2.11
    ## 2     0.930     NaN          2.11
    ## 3     0.921     NaN          2.09
...
![](p8105_hw6_qh2284_files/figure-gfm/unnamed-chunk-16-1.png)<!-- -->

Comment: log(beta0\*beta1) are approximately normal distribution (with a
little left skewed).
...
![](p8105_hw6_qh2284_files/figure-gfm/unnamed-chunk-20-1.png)<!-- -->
...
![](p8105_hw6_qh2284_files/figure-gfm/unnamed-chunk-23-1.png)<!-- -->
